...
TILE_WIDTH, TILE_HEIGHT = 55, 70
BARVA_PATRO_1, BARVA_PATRO_2, BARVA_PATRO_3, BARVA_PATRO_4 = (128, 19, 102), (128, 19, 102), (128, 19, 102), (128, 19, 102)
SCENA = "menu"
active_position = ()
...
posun = 11 # uhel pohledu hry

shuffle_button_pos = pygame.Rect((WIN_X - 150) / 2, 635, 150, 60)
hrat_btn_pos = pygame.Rect(WIN_X/2 - 150, WIN_Y/2 + 100, 300, 100)

#########################################################################

tiles_img = ["Bamboo1.png","Bamboo2.png","Bamboo3.png","Bamboo4.png","Bamboo5.png","Bamboo6.png","Bamboo7.png","Bamboo8.png","Bamboo9.png","Circle1.png","Circle2.png","Circle3.png","Circle4.png","Circle5.png","Circle6.png","Circle7.png","Circle8.png","Circle9.png","Char1.png","Char2.png","Char3.png","Char4.png","Char5.png","Char6.png","Char7.png","Char8.png","Char9.png","Plant1.png","Plant2.png","Plant3.png","Plant4.png","Plant5.png","Plant6.png","Plant7.png","Plant8.png"]
for i in range(len(tiles_img)):
    tiles_img[i] = pygame.transform.scale(pygame.image.load("tiles/" + tiles_img[i]), (TILE_WIDTH - 5, TILE_HEIGHT - 5))
...
def nova_hra():
    global patro1, patro2, patro3, patro4, tile, vyhra_hodnota
...
def draw():
    if SCENA == "menu":
        ...
        txt = font_nadpis.render("Mahjong Solitaire", True, (255,255,255))
        ...
        for x in range(12):     #prvni patro
            for y in range(8):
                if patro1[y][x] != "x":
                    sc.blit(tiles_img[patro1[y][x]], (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 2, y * (TILE_HEIGHT + 2) + 50 + 2, TILE_WIDTH, TILE_HEIGHT))
                    #na kazdy platny policko vykresli rect
                    if active_position != (x, y, 1):
                        pygame.draw.rect(sc, BARVA_PATRO_1, (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6, y * (TILE_HEIGHT + 2) + 50, TILE_WIDTH, TILE_HEIGHT), 2, 10)
                    #pokud neni aktivni, obtazeno defaultní barvou patra
                    elif active_position[2] == 1:
                        pygame.draw.rect(sc, (200, 0, 0), (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6, y * (TILE_HEIGHT + 2) + 50, TILE_WIDTH, TILE_HEIGHT), 4, 10)
        ...
        for x in range(6):     #druhe patro
            for y in range(6):
                if patro2[y][x] != "x":
                    ...
                    sc.blit(tiles_img[patro2[y][x]], (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 3 * (TILE_WIDTH + 2) - posun + 2, y * (TILE_HEIGHT + 2) + 50 + 1 * (TILE_HEIGHT + 2) - posun + 2, TILE_WIDTH, TILE_HEIGHT))
                    #na kazdy platny policko vykresli rect
                    if active_position != (x, y, 2):
                        pygame.draw.rect(sc, BARVA_PATRO_2, (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 3 * (TILE_WIDTH + 2) - posun, y * (TILE_HEIGHT + 2) + 50 + 1 * (TILE_HEIGHT + 2) - posun, TILE_WIDTH, TILE_HEIGHT), 2, 10)
                    #pokud neni aktivni, obtazeno defaultní barvou patra
                    elif active_position[2] == 2:
                        pygame.draw.rect(sc, (200, 0, 0), (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 3 * (TILE_WIDTH + 2) - posun, y * (TILE_HEIGHT + 2) + 50 + 1 * (TILE_HEIGHT + 2) - posun, TILE_WIDTH, TILE_HEIGHT), 4, 10)
                    #pokud je aktivni, obtazeno zelenou
        ...
        for x in range(4):     #treti patro
            for y in range(4):
                if patro3[y][x] != "x":
                    ...
                    sc.blit(tiles_img[patro3[y][x]], (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 4 * (TILE_WIDTH + 2) - posun*2 + 2, y * (TILE_HEIGHT + 2) + 50 + 2 * (TILE_HEIGHT + 2) - posun*2 + 2, TILE_WIDTH, TILE_HEIGHT))
                    #na kazdy platny policko vykresli rect
                    if active_position != (x, y, 3):
                        pygame.draw.rect(sc, BARVA_PATRO_3, (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 4 * (TILE_WIDTH + 2) - posun*2, y * (TILE_HEIGHT + 2) + 50 + 2 * (TILE_HEIGHT + 2) - posun*2, TILE_WIDTH, TILE_HEIGHT), 2, 10)
                    #pokud neni aktivni, obtazeno defaultní barvou patra
                    elif active_position[2] == 3:
                        pygame.draw.rect(sc, (200, 0, 0), (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 4 * (TILE_WIDTH + 2) - posun*2, y * (TILE_HEIGHT + 2) + 50 + 2 * (TILE_HEIGHT + 2) - posun*2, TILE_WIDTH, TILE_HEIGHT), 4, 10)
        ...
        for x in range(2):     #ctvrte patro
            for y in range(2):
                if patro4[y][x] != "x":
                    ...
                    sc.blit(tiles_img[patro4[y][x]], (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 5 * (TILE_WIDTH + 2) - posun*3 + 2, y * (TILE_HEIGHT + 2) + 50 + 3 * (TILE_HEIGHT + 2) - posun*3 + 2, TILE_WIDTH, TILE_HEIGHT))
                    #na kazdy platny policko vykresli rect
                    if active_position != (x, y, 4):
                        pygame.draw.rect(sc, BARVA_PATRO_4, (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 5 * (TILE_WIDTH + 2) - posun*3, y * (TILE_HEIGHT + 2) + 50 + 3 * (TILE_HEIGHT + 2) - posun*3, TILE_WIDTH, TILE_HEIGHT), 2, 10)
                    #pokud neni aktivni, obtazeno defaultní barvou patra
                    elif active_position[2] == 4:
                        pygame.draw.rect(sc, (200, 0, 0), (x * (TILE_WIDTH + 2) + WIN_X / 2 - (TILE_WIDTH + 2) * 6 + 5 * (TILE_WIDTH + 2) - posun*3, y * (TILE_HEIGHT + 2) + 50 + 3 * (TILE_HEIGHT + 2) - posun*3, TILE_WIDTH, TILE_HEIGHT), 4, 10)
                    #pokud je aktivni, obtazeno zelenou
